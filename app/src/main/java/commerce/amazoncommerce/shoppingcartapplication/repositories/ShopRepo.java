package commerce.amazoncommerce.shoppingcartapplication.repositories;
...
public class ShopRepo {
    ...
    private void loadProducts(){
        ...
        productList.add( new Product( UUID.randomUUID().toString(), "iMac 21" , 1111, true, "https://firebasestorage.googleapis.com/v0/b/notes-16738.appspot.com/o/products%2Fimac21.jpeg?alt=media&token=e1cf1537-ab30-44a3-91f1-4d6284e79540" ) );
